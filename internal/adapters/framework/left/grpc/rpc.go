...
func (grpca Adapter) GetAddition(ctx context.Context, req *pb.OprationParameters) (*pb.Answer, error) {
	var err error
	ans := &pb.Answer{}
...
func (grpca Adapter) GetSubtraction(ctx context.Context, req *pb.OprationParameters) (*pb.Answer, error) {
	var err error
	ans := &pb.Answer{}
...
func (grpca Adapter) GetMultiplication(ctx context.Context, req *pb.OprationParameters) (*pb.Answer, error) {
	var err error
	ans := &pb.Answer{}
...
func (grpca Adapter) GetDivision(ctx context.Context, req *pb.OprationParameters) (*pb.Answer, error) {
	var err error
	ans := &pb.Answer{}
